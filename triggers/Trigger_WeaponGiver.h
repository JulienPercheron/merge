...
public:
  ...
  Trigger_WeaponGiver(Vector2D pos, Raven_Team* team, int graphNode); //--------------------New
  ...
  bool canBePickedUp(Raven_Bot* bot) const override { return ((teamSpecific == nullptr) || teamSpecific == bot->GetTeam()); }  //--------------------New (override Trigger.h)
