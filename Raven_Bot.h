...
private:
  ...
  Raven_Team* m_team; //------------------------------------------------------------------------- Nouvel attribut
...
public:
  ...
  void			SetTeam(Raven_Team* team) { this->m_team = team; } //------------------------------------Nouvelle méthode
  ...
  //Permet de prendre la possession du bot lors du chargement de la map ------------------------Nouvelle méthode
  void			TakePossessionWhenLoadingMap();
  ...
  Raven_Team* const	GetTeam()const { return m_team ? m_team : nullptr; }//-----------------Nouvelle méthode

  void ChangeBotDrawColor()const;
