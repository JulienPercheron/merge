; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27034.0 
	...
	TITLE	D:\Git\Tp3_MiniProjetRaven\Raven\VS2015\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG37051 DB	'explore', 00H
$SG37053 DB	'think', 00H
	ORG $+2
$SG37055 DB	'arrive_at_position', 00H
	ORG $+1
$SG37057 DB	'seek_to_position', 00H
	ORG $+3
$SG37059 DB	'follow_path', 00H
$SG37061 DB	'traverse_edge', 00H
	ORG $+2
$SG37063 DB	'move_to_position', 00H
	ORG $+3
$SG37065 DB	'get_health', 00H
	ORG $+1
$SG37067 DB	'get_shotgun', 00H
$SG37069 DB	'get_railgun', 00H
$SG37071 DB	'get_rocket_launcher', 00H
$SG37073 DB	'wander', 00H
	ORG $+1
$SG37075 DB	'negotiate_door', 00H
	ORG $+1
$SG37077 DB	'attack_target', 00H
	ORG $+2
$SG37079 DB	'hunt_target', 00H
$SG37081 DB	'strafe', 00H
	ORG $+1
$SG37083 DB	'adjust_range', 00H
	ORG $+3
$SG37085 DB	'say_phrase', 00H
	ORG $+1
$SG37087 DB	'escape', 00H
	ORG $+1
$SG37089 DB	'UNKNOWN GOAL TYPE!', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\goals\raven_goal_types.cpp
...
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\goals\raven_goal_types.h
