; Listing generated by Microsoft (R) Optimizing Compiler Version 19.27.29111.0 
	...
	TITLE	F:\Téléchargements\solution_lab_apprentissage - Copie\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG156831 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
$SG161565 DB	'invalid argument', 00H
	ORG $+3
$SG156832 DB	'F', 00H, ':', 00H, '\', 00H, 'T', 00H, 0e9H, 00H, 'l', 00H
...
$SG161566 DB	'%s', 00H
	ORG $+1
$SG156833 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
	...
	DB	00H
	ORG $+6
$SG161567 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.27.29110\include\xmemory', 00H
$SG161568 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG161569 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG161570 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File F:\Téléchargements\solution_lab_apprentissage - Copie\Common\Game\BaseGameEntity.cpp
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG156831
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG156832
	push	OFFSET $SG156833
	call	__wassert
