; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27034.0 
	...
	TITLE	D:\Git\Tp3_MiniProjetRaven\Raven\VS2015\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG152463 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG152464 DB	'd', 00H, ':', 00H, '\', 00H, 'g', 00H, 'i', 00H, 't', 00H
	...
	ORG $+2
$SG152465 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\common\game\basegameentity.cpp
...
; 13   :   SetID(m_iNextValidID);

	mov	ecx, DWORD PTR ?m_iNextValidID@BaseGameEntity@@0HA ; BaseGameEntity::m_iNextValidID
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG152463
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG152464
	push	OFFSET $SG152465
	call	__wassert
