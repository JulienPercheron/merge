; Listing generated by Microsoft (R) Optimizing Compiler Version 19.27.29111.0 
	...
	TITLE	F:\Téléchargements\solution_lab_apprentissage - Copie\Buckland_Chapter7 to 10_Raven_apprentissage\goals\Raven_Feature.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
	ORG $+3
$SG199899 DB	'invalid argument', 00H
	ORG $+3
$SG199900 DB	'%s', 00H
	ORG $+1
$SG199901 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.27.29110\include\xmemory', 00H
$SG199902 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG199903 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG199904 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG200158 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.27.29110\include\xlocale', 00H
$SG185539 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
$SG185541 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG185543 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG185546 DB	'trying to calculate  of unknown weapon', 00H
CONST	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG199899
	push	OFFSET $SG199900
	push	0
	push	121					; 00000079H
	push	OFFSET $SG199901
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	121					; 00000079H
	push	OFFSET $SG199902
	push	OFFSET $SG199903
	push	OFFSET $SG199904
	call	__invalid_parameter
	add	esp, 20					; 00000014H
	xor	ecx, ecx
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File F:\Téléchargements\solution_lab_apprentissage - Copie\Buckland_Chapter7 to 10_Raven_apprentissage\goals\Raven_Feature.cpp
