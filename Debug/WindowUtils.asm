; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27034.0 
	...
	TITLE	D:\Git\Tp3_MiniProjetRaven\Raven\VS2015\Common\misc\WindowUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG151278 DB	'Error', 00H
	ORG $+2
$SG151282 DB	'Error', 00H
	ORG $+2
$SG151373 DB	'*.*', 00H
$SG151374 DB	'All Files (*.*)', 00H
$SG151375 DB	'*.', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\program files (x86)\microsoft visual studio\2017\community\vc\tools\msvc\14.16.27023\include\iomanip
...
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\common\misc\stream_utility_functions.h
...
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\common\misc\windowutils.cpp
...
; 109  :                        "All Files (*.*)" + '\0' + "*.*" + '\0' + '\0';
	...
	push	0
	push	0
	push	OFFSET $SG151373
	push	0
	push	OFFSET $SG151374
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG151375
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
