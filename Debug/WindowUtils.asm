; Listing generated by Microsoft (R) Optimizing Compiler Version 19.27.29111.0 
	...
	TITLE	F:\Téléchargements\solution_lab_apprentissage - Copie\Common\misc\WindowUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG155663 DB	'Error', 00H
	ORG $+2
$SG155667 DB	'Error', 00H
	ORG $+2
$SG155766 DB	'*.*', 00H
$SG155767 DB	'All Files (*.*)', 00H
$SG155768 DB	'*.', 00H
	ORG $+1
$SG161134 DB	'invalid argument', 00H
	ORG $+3
$SG161135 DB	'%s', 00H
	ORG $+1
$SG161136 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.27.29110\include\xmemory', 00H
$SG161137 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG161138 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG161139 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG161134
	push	OFFSET $SG161135
	push	0
	push	121					; 00000079H
	push	OFFSET $SG161136
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	121					; 00000079H
	push	OFFSET $SG161137
	push	OFFSET $SG161138
	push	OFFSET $SG161139
...
; 194  :     basic_ostream& __CLR_OR_THIS_CALL operator<<(ios_base&(__cdecl* _Pfn)(ios_base&) ) { // call ios_base manipulator
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File F:\Téléchargements\solution_lab_apprentissage - Copie\Common\misc\Stream_Utility_Functions.h
...
; Function compile flags: /Odtp /RTCsu
; File F:\Téléchargements\solution_lab_apprentissage - Copie\Common\misc\WindowUtils.cpp
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	0
	push	OFFSET $SG155766
	push	0
	push	OFFSET $SG155767
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG155768
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 3576 :     _NODISCARD reference at(const size_type _Off) {
...
; 3577 :         _Mypair._Myval2._Check_offset_exclusive(_Off);
...
; 2162 :     void _Check_offset_exclusive(const size_type _Off) const { // checks whether _Off is in the bounds of [0, size())
