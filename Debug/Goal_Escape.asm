; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27034.0 
	...
	TITLE	D:\Git\Tp3_MiniProjetRaven\Raven\VS2015\Buckland_Chapter7 to 10_Raven\goals\Goal_Escape.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Activate@Goal_Escape@@UAEXXZ			; Goal_Escape::Activate
PUBLIC	?Process@Goal_Escape@@UAEHXZ			; Goal_Escape::Process
PUBLIC	?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z ; Goal_Escape::HandleMessage
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z$0
__ehfuncinfo$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?Activate@Goal_Escape@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_Escape@@UAEXXZ$0
__ehfuncinfo$?Activate@Goal_Escape@@UAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?Activate@Goal_Escape@@UAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
; 212  :   Raven_PathPlanner* const           GetPathPlanner(){return m_pPathPlanner;}
...
; 210  :   Raven_Game* const                  GetWorld(){return m_pWorld;} 
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\goals\goal_escape.cpp
;	COMDAT ?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z
_TEXT	SEGMENT
tv160 = -44						; size = 4
tv173 = -40						; size = 4
tv74 = -36						; size = 4
...
__$EHRec$ = -12						; size = 12
_msg$ = 8						; size = 4
?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z PROC	; Goal_Escape::HandleMessage, COMDAT
; _this$ = ecx
...
; 57   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 58   : 	//first, pass the message down the goal hierarchy
; 59   : 	bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 60   : 
; 61   : 	//if the msg was not handled, test to see if this goal can handle it
; 62   : 	if (bHandled == false)
...
; 65   : 		{
; 66   : 		case Msg_PathReady:
; 67   : 
; 68   : 			//clear any existing goals
; 69   : 			RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 70   : 
; 71   : 			AddSubgoal(new Goal_FollowPath(m_pOwner,
...
; 72   : 				m_pOwner->GetPathPlanner()->GetPath()));
; 73   : 
; 74   : 			return true; //msg handled
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z$0:
	push	40					; 00000028H
	...
	add	esp, 8
	ret	0
__ehhandler$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-40]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?HandleMessage@Goal_Escape@@UAE_NABUTelegram@@@Z ENDP	; Goal_Escape::HandleMessage
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\goals\goal_escape.cpp
;	COMDAT ?Process@Goal_Escape@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_Escape@@UAEHXZ PROC			; Goal_Escape::Process, COMDAT
; _this$ = ecx
...
; 51   : }
	...
	pop	ebp
	ret	0
?Process@Goal_Escape@@UAEHXZ ENDP			; Goal_Escape::Process
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\goals\goal_escape.cpp
;	COMDAT ?Activate@Goal_Escape@@UAEXXZ
_TEXT	SEGMENT
tv163 = -44						; size = 4
$T2 = -40						; size = 4
$T3 = -36						; size = 4
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Activate@Goal_Escape@@UAEXXZ PROC			; Goal_Escape::Activate, COMDAT
; _this$ = ecx
...
; 17   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Activate@Goal_Escape@@UAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 32					; 00000020H
	push	esi
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?Activate@Goal_Escape@@UAEXXZ$0:
	push	48					; 00000030H
	...
	add	esp, 8
	ret	0
__ehhandler$?Activate@Goal_Escape@@UAEXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-40]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Activate@Goal_Escape@@UAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?Activate@Goal_Escape@@UAEXXZ ENDP			; Goal_Escape::Activate
; Function compile flags: /Odtp /RTCsu
