; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27034.0 
	...
	TITLE	D:\Git\Tp3_MiniProjetRaven\Raven\VS2015\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?IsInSameTeam@Raven_TargetingSystem@@QBE_NPAVRaven_Bot@@0@Z ; Raven_TargetingSystem::IsInSameTeam
...
PUBLIC	?GetName@Raven_Team@@QAEAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ; Raven_Team::GetName
...
PUBLIC	?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ	; Raven_Bot::GetTeam
...
; 32   : 	{	// compare [_Left, _Left + _Left_size) to [_Right, _Right + _Right_size) using _Traits
...
; 33   : 	const int _Ans = _Traits::compare(_Left, _Right, _Min_value(_Left_size, _Right_size));
...
;	COMDAT ?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ
_TEXT	SEGMENT
tv67 = -8						; size = 4
_this$ = -4						; size = 4
?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ PROC		; Raven_Bot::GetTeam, COMDAT
; _this$ = ecx

; 220  :   Raven_Team* const	GetTeam()const { return m_team ? m_team : nullptr; }//-----------------Nouvelle méthode
	...
	je	SHORT $LN3@GetTeam
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+272]
	mov	DWORD PTR tv67[ebp], edx
	jmp	SHORT $LN4@GetTeam
$LN3@GetTeam:
...
$LN4@GetTeam:
	...
	pop	ebp
	ret	0
?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ ENDP		; Raven_Bot::GetTeam
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\raven_bot.h
...
; 218  :   Raven_SensoryMemory* const         GetSensoryMem()const{return m_pSensoryMem;}
...
; 158  :   bool          isAlive()const{return m_Status == alive;}
...
;	COMDAT ?GetName@Raven_Team@@QAEAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetName@Raven_Team@@QAEAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ PROC ; Raven_Team::GetName, COMDAT
; _this$ = ecx
...
; 51   : 	std::string& GetName() { return m_name; };
	...
	pop	ebp
	ret	0
?GetName@Raven_Team@@QAEAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ENDP ; Raven_Team::GetName
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\program files (x86)\microsoft visual studio\2017\community\vc\tools\msvc\14.16.27023\include\list
...
; 884  : 		{	// swap with empty *this, same allocator
...
; 886  : 		_Swap_adl(this->_Myhead(), _Right._Myhead());
...
; 887  : 		_STD swap(this->_Mysize(), _Right._Mysize());
...
; 874  : 		if (this != _STD addressof(_Right))
...
; 875  : 			{	// different, assign it
; 876  : 			clear();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?clear@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAEXXZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::clear

; 877  : 			this->_Move_alloc(_Right._Getal());
...
; 878  : 			_Assign_rv(_STD move(_Right), bool_constant<_Always_equal_after_move<_Alnode>>{});
...
; 637  : 		_Get_data()._Swap_all(_Right._Get_data());
...
; 580  : 		const bool _Reload = _Alnode_traits::propagate_on_container_move_assignment::value
; 581  : 			&& _Getal() != _Al;
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
...
; 84   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenOutOfView(m_pCurrentTarget);
...
; 79   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenVisible(m_pCurrentTarget);
...
; 74   :   return m_pOwner->GetSensoryMem()->GetLastRecordedPositionOfOpponent(m_pCurrentTarget);
...
; 69   :   return m_pOwner->GetSensoryMem()->isOpponentShootable(m_pCurrentTarget);
...
; 64   :   return m_pOwner->GetSensoryMem()->isOpponentWithinFOV(m_pCurrentTarget);
...
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
;	COMDAT ?IsInSameTeam@Raven_TargetingSystem@@QBE_NPAVRaven_Bot@@0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_bot1$ = 8						; size = 4
_bot2$ = 12						; size = 4
?IsInSameTeam@Raven_TargetingSystem@@QBE_NPAVRaven_Bot@@0@Z PROC ; Raven_TargetingSystem::IsInSameTeam, COMDAT
; _this$ = ecx

; 52   : bool Raven_TargetingSystem::IsInSameTeam(Raven_Bot* bot1, Raven_Bot* bot2)const {//----------------------------------Nouvelle méthode
...
; 53   : 	if (bot1->GetTeam() && bot2->GetTeam()) {

	mov	ecx, DWORD PTR _bot1$[ebp]
	call	?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ ; Raven_Bot::GetTeam
	test	eax, eax
	je	SHORT $LN2@IsInSameTe
	mov	ecx, DWORD PTR _bot2$[ebp]
	call	?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ ; Raven_Bot::GetTeam
	test	eax, eax
	je	SHORT $LN2@IsInSameTe

; 54   : 		if (bot1->GetTeam()->GetName().compare(bot2->GetTeam()->GetName()) == 0) {

	mov	ecx, DWORD PTR _bot2$[ebp]
	call	?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ ; Raven_Bot::GetTeam
	mov	ecx, eax
	call	?GetName@Raven_Team@@QAEAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ; Raven_Team::GetName
	push	eax
	mov	ecx, DWORD PTR _bot1$[ebp]
	call	?GetTeam@Raven_Bot@@QBEQAVRaven_Team@@XZ ; Raven_Bot::GetTeam
	mov	ecx, eax
	...
	test	eax, eax
	jne	SHORT $LN2@IsInSameTe

; 55   : 			return false;

	xor	al, al
	jmp	SHORT $LN1@IsInSameTe
$LN2@IsInSameTe:
...
; 59   : }
	...
	pop	ebp
	ret	8
?IsInSameTeam@Raven_TargetingSystem@@QBE_NPAVRaven_Bot@@0@Z ENDP ; Raven_TargetingSystem::IsInSameTeam
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\tp3_miniprojetraven\raven\vs2015\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
...
$T7 = -84						; size = 12
_dist$8 = -72						; size = 8
_curBot$9 = -60						; size = 12
_SensedBots$10 = -40					; size = 12
...
; 21   :   double ClosestDistSoFar = MaxDouble;
...
; 23   : 
; 24   :   //S'il n'y a pas de cible prioritaire, on tape sur tout ce qui bouge. Sinon on va la traquer
; 25   :   //jusqu'à ce qu'il n'y ait plus de cible prioritaire (quand elle meurt par exemple)
; 26   :   if (!m_pPrimaryTarget) {

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	jne	$LN5@Update

; 27   : 	  //grab a list of all the opponents the owner can sense
; 28   : 	  std::list<Raven_Bot*> SensedBots;

	lea	ecx, DWORD PTR _SensedBots$10[ebp]
...
; 29   : 	  SensedBots = m_pOwner->GetSensoryMem()->GetListOfRecentlySensedOpponents();
...
; 30   : 
; 31   : 	  std::list<Raven_Bot*>::const_iterator curBot = SensedBots.begin();
	...
	push	eax
	lea	ecx, DWORD PTR _curBot$9[ebp]
...
; 32   : 	  for (curBot; curBot != SensedBots.end(); ++curBot)
...
; 33   : 	  {
; 34   : 		  //make sure the bot is alive and that it is not the owner and not in the same team
; 35   : 		  if ((*curBot)->isAlive() && (*curBot != m_pOwner) && IsInSameTeam(*curBot, m_pOwner)){
	...
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?IsInSameTeam@Raven_TargetingSystem@@QBE_NPAVRaven_Bot@@0@Z ; Raven_TargetingSystem::IsInSameTeam
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN8@Update

; 36   : 			  double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
...
; 39   : 			  {
; 40   : 				  ClosestDistSoFar = dist;

	movsd	xmm0, QWORD PTR _dist$8[ebp]
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 41   : 				  m_pCurrentTarget = *curBot;
...
; 47   : 	  m_pCurrentTarget = m_pPrimaryTarget;
...
; 3809 : 		{	// compare [0, size()) with _Right
...
; 3810 : 		auto& _My_data = this->_Get_data();
...
; 3811 : 		auto& _Right_data = _Right._Get_data();

	mov	ecx, DWORD PTR __Right$[ebp]
	call	?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$_String_val@U?$_Simple_types@D@std@@@2@XZ ; std::_String_alloc<std::_String_base_types<char,std::allocator<char> > >::_Get_data
	mov	DWORD PTR __Right_data$[ebp], eax

; 3812 : 		return (_Traits_compare<_Traits>(_My_data._Myptr(), _My_data._Mysize,
...
; 3813 : 			_Right_data._Myptr(), _Right_data._Mysize));
; 3814 : 		}
